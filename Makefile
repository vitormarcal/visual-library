# Image name
IMAGE_NAME ?= ghcr.io/vitormarcal/visual-library
...
help:
	@echo ""
	@echo "visual-library Docker Makefile"
	@echo ""
	@echo "Main commands:"
	...
	@echo "  IMAGE_NAME=ghcr.io/vitormarcal/visual-library"
	@echo "  VERSION=dev"
	...
	@echo "  - Runtime data lives in /app/data."
	@echo ""
